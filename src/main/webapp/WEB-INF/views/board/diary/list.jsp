...
<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
    ...
    <link rel="stylesheet" href="/mcommunity/res/css/skin/diary/css/evo-calendar.min.css">
    <link rel="stylesheet" href="/mcommunity/res/css/skin/diary/css/style.css">
    <script src="/mcommunity/res/js/skin/diary/js/evo-calendar.js"></script>
    <script>
        $(function () {
