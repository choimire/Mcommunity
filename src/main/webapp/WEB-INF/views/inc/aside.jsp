...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>  
        ...
        <div class="panel-body p-1">
            <sec:authorize access="isAuthenticated()">
               ...
               <sec:authorize access="hasRole('ROLE_ADMIN')">
                  | <a href="/mcommunity/admin">관리자모드</a> 
               </sec:authorize>
                  </div> 
               <p class="text-center"><a href="/mcommunity/logout">로그아웃</a></p>
            </sec:authorize>
            <sec:authorize access="!isAuthenticated()">
          <form accept-charset="UTF-8" action="/mcommunity/login" method="post" role="form">
                    <fieldset>
   ...
   <ul class='list-group list-group-flush mt-5 mb-5'>
     <c:forEach var="blists" items="${baLists}">
      <li class="list-group-item d-flex justify-content-between align-items-center">
         <a href="board?bid=${blists.id }">${blists.btitle }</a> 
         <span class="badge badge-primary badge-pill">${blists.bbsCount }</span>
      </li>
     </c:forEach>          
   </ul>